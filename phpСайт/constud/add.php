...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO public.student_contests (contest_id,student_id) VALUES (:contest_id,:student_id)";
    ...
    try {
        ...
        $_SESSION['success_message'] = "Запись на конкурс успешно добавлена";
        header("Location: list.php");
        exit();
    } catch (PDOException $e) {
...
$stmt_contests = $pdo->query("SELECT * FROM public.contests");
